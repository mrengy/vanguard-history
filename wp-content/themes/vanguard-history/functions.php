...
function vanguard_history_populate_thumbnails($media_query)
{
	...
	if ($media_query->have_posts()) : while ($media_query->have_posts()) : $media_query->the_post();
			...
			if (str_contains($file_type, 'video')) {
				...
				$this_img_string = "<div class='video-thumbnail-wrapper'><img class='attachment-thumbnail size-thumbnail video-thumbnail' src='$this_thumbnail' alt='$this_thumbnail_alt' decoding='async' loading='lazy' width='150' height='150'/></div>";
				...
				$this_img_string = "<div class='audio-thumbnail-wrapper'><img class='attachment-thumbnail size-thumbnail audio-thumbnail' src='$site_url" . "/wp-content/plugins/media-library-assistant/images/crystal/audio.png" . "' alt='$this_media_alt' title='$this_media_title' decoding='async' loading='lazy' width='150' height='150'/></div>";
				$thumbnails[] = wp_get_attachment_link($this_id, '', true, false, $this_img_string, '');
