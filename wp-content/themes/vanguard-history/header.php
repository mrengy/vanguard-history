	...
	<?php
		...
		<header id="masthead" class="site-header ui container">
			<div class="site-branding">
				...
				if ( is_front_page() && is_home() ) :
					...
					if ( $vanguard_history_description || is_customize_preview() ) :
						?>
						<p class="site-description"><?php echo $vanguard_history_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
					<?php
					endif;
				else :
					?>
			...
			<nav id="site-navigation" class="main-navigation">
				<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'vanguard-history' ); ?></button>
				<?php
				wp_nav_menu(
					array(
